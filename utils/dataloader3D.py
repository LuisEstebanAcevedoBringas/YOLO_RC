...
aux_n, aux_i, aux_s = 'v_Basketball_g01_c01','00001','Basketball'
...
# ------------------------ Luiggi ------------------------
    ...
    def load_mosaic_Luiggi(self ,eme, s_rpv, yc, xc, indices, final_stacks):
        ...
        for i, index in enumerate(indices):
            # Load image
            video_n, video_i, fp , sub_folder = get_info(final_stacks[i])
            if dataset == 'ipn':
                img, _, (h, w) = self.load_image_Luiggi(fp + "{}_{:06d}.jpg".format(video_n,video_i))
                # img, _, (h, w) = self.load_image_Luiggi(fp + "{}/".format(video_n) + "{:06d}.jpg".format(video_i))
            elif dataset == 'ucf' or dataset == 'jhmdb':
                img, _, (h, w) = self.load_image_Luiggi(fp + "{}/".format(sub_folder) + "{}/".format(video_n) + "/" + "{:05d}.jpg".format(int(video_i)))
            elif dataset == 'jhmdb':
                img, _, (h, w) = self.load_image_Luiggi(fp + "{}/".format(sub_folder) + "{}/".format(video_n) + "/" + "{:05d}.png".format(int(video_i)))
...
def get_info(path):
    ...
    if dataset == "ipn":
        ...
        sub_carpet = ''
        return video_name, video_indice, final_path, sub_carpet
        ...
        # print(f"split_result: {split_result}")
            video_name = file_name.split("_")[1] + "_" + file_name.split("_")[2] + "_" + file_name.split("_")[3] + "_" + file_name.split("_")[4]
            video_indice = int(file_name.split("_")[6])
            sub_carpet = file_name.split("_")[0]
        # aux_n = video_name
        # aux_i = video_indice
        # aux_s = sub_carpet
            return video_name, video_indice, final_path, sub_carpet
        except:
            return aux_n, aux_i, final_path, aux_s
    
    elif dataset == "jhmdb":
        video_name = file_name.split("_")[1] + "_" + file_name.split("_")[2] + "_" + file_name.split("_")[3] + "_" + file_name.split("_")[4] + "_" + file_name.split("_")[5] + "_" + file_name.split("_")[6]
        video_indice = int(file_name.split("_")[7])
        sub_carpet = file_name.split("_")[0]
        return video_name, video_indice, final_path, sub_carpet
...
def generate_stack(path, clip_size):
    ...
    if dataset == 'ipn':
        ...
        if video_i < clip_size:
            dif = clip_size - video_i
            for i in range(video_i, 0, -1):
                data.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.jpg".format(i))
            for _ in range(dif):
                data.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.jpg".format(1))
        else:
            for _ in range(video_i, (video_i - (clip_size)), -1):
                data.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.jpg".format(video_i))
        ...
        if video_i < clip_size:
            dif = clip_size - video_i
            for i in range(video_i, 0, -1):
                data.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.png".format(i))
            for _ in range(dif):
                data.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.png".format(1))
        else:
            for _ in range(video_i, (video_i - (clip_size)), -1):
                data.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.png".format(video_i))
...
def generate_n_stacks(paths, clip_size): # We return all the volumes of images for the stacks
    ...
    if dataset == 'ipn':
        ...
        for n in paths:  
            stack_n = []
            video_n, video_i, _, sub_carpet = get_info(n)
            if video_i < clip_size:
                dif = clip_size - video_i
                for i in range(video_i, 0, -1):
                    stack_n.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.jpg".format(i))
                for _ in range(dif):
                    stack_n.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.jpg".format(1))
            else:
                for _ in range(video_i, (video_i - (clip_size)), -1):
                    stack_n.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.jpg".format(video_i))
                    video_i -= 1
            data.append(stack_n)
        ...
        for n in paths:  
            ...
            if video_i < clip_size:
                dif = clip_size - video_i
                for i in range(video_i, 0, -1):
                    stack_n.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.png".format(i))
                for _ in range(dif):
                    stack_n.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.png".format(1))
            else:
                for _ in range(video_i, (video_i - (clip_size)), -1):
                    stack_n.append(img_paths + "{}/".format(sub_carpet) + "{}/".format(video_n) + "{:05d}.png".format(video_i))
                    video_i -= 1
            data.append(stack_n)
